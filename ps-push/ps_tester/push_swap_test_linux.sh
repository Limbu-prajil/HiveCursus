...
printf "\n${BLACK}⚠️ This test is was very long, still lengthy to get bored. It is recommended to use it only when the project is finished or in an evaluation ⚠️${DEF_COLOR}\n\n\n";
